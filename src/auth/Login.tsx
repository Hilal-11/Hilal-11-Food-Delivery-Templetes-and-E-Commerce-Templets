...
function Login() {
    ...
    const loginSubmitHandler = (event) => {
      ...
      navigate('/authentication/varification')
    }
  return (
      ...
      <div className='lg:flex lg:items-center lg:justify-center lg:h-svh'>
        ...
        <div className='h-[30%] bg-orange-500'>
            ...
            <div className='lg:hidden text-center py-3'>
              <h1 className='Inter-bold text-4xl text-white'>Login</h1>
          ...
          <form className='space-y-6'>
            ...
            <div className=''>
              ...
              <div className='flex justify-between py-3 px-2'>
                ...
                <div>
                  <span className='text-orange-600 Inter-medium text-[17px]'>Foget Password</span>
                </div>
              </div>
            </div>
            ...
            <div className=''>
              <div className='text-center'>
                <p className='text-[18px]'>Don't have an account? <span className='Inter-medium text-orange-600'>Signup</span></p>
